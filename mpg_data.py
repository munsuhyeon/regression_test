...
x_fea = ['cylinders','disp;acement','weight','acceleration','model_year']
...
plt.show()'''
print('연비를 예측하고 싶은 자동타의 정보를 입력하세요.')
cylinders0 = input('실린더수를 입력하세요:')
cylinders0 = int(cylinders0)
displacement = input('배기량을 입력하세요:')
...
mpg_predict = lr.predict([[cylinders0, displacement, weight_, acceleration_, model_year_]])
