...
plt.xlabel(toluca_data['Lot_size'],toluca_values, color=red)
...
print('')
print(toluca_fit.resid)# 잔차(실제 데이터와 회귀모델간의 예측값과의 오차)

plt.scatter(toluca_data['Lot_size'], toluca_fit.resid) # 잔차도
plt.show()